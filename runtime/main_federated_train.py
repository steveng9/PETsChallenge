...
import examples_src.fincrime.solution_federated as solution_federated
...
if __name__ == "__main__":
    ...
    supervisor = FederatedSupervisor(partition_config_path=Path("C:/Users/deek/PycharmProjects/pythonProject-PETs3/data/fincrime/scenario01/train/partitions.json"))
